...
The tool provides a graphical user interface (GUI) that allows administrators to run SCCM client actions, evaluate configuration baselines, perform basic client health checks, and troubleshoot common Configuration Manager client issues.
